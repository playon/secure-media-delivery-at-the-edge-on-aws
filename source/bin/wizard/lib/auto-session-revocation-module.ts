...
},
{
  ...
  validate: (value: string) => Joi.string().required().validate(value).error ?
    'The name of the Database is mandatory' : true
},
{
  type: 'text',
  name: 'table_name',
...
},
{
  ...
  initial: 'request_ip',
  validate: (value: string) => Joi.string().required().validate(value).error ?
    'Request IP column is mandatory' : true
},
{
  type: 'text',
  name: 'ua_column_name',
  ...
  validate: (value: string) => Joi.string().required().validate(value).error ?
    'UA column name is mandatory' : true
},
{
  type: 'text',
  ...
  validate: (value: string) => Joi.string().required().validate(value).error ?
    'Referer column name is mandatory' : true
},
{
  type: 'text',
  ...
  validate: (value: string) => Joi.string().required().validate(value).error ?
    'URI column name is mandatory' : true
},
{
  type: 'text',
  ...
  validate: (value: string) => Joi.string().required().validate(value).error ?
    'Status column name is mandatory' : true
},
{
  type: 'text',
  ...
  validate: (value: string) => Joi.string().required().validate(value).error ?
    'Response bytes column name is mandatory' : true
},
{
  type: 'text',
  ...
  validate: (value: string) => Joi.string().required().validate(value).error ?
    'Date column name is mandatory' : true
},
{
  type: 'text',
  ...
  validate: (value: string) => Joi.string().required().validate(value).error ?
    'Time column name is mandatory' : true
},
{
  type: 'text',
  ...
  validate: (value: number) => Joi.number().required().validate(value).error ?
    'Lookback period is mandatory' : true
},
{
  type: 'select',
  name: 'ip_penalty',
...
},
{
  ...
  initial: 3,
  validate: (value: number) => Joi.number().required().validate(value).error ?
    'Minimum sessions number is mandatory' : true
},
{
  type: 'text',
  ...
  validate: (value: number) => Joi.number().required().validate(value).error ?
    'Minimum sessions duration is mandatory' : true
},
{
  type: 'text',
