...
export class Endpoints extends Construct {
    ...
    private API_GATEWAY_LOG_FORMAT: string = '{"requestId":"$context.requestId","ip": "$context.identity.sourceIp","requestTime":"$context.requestTime","requestTimeEpoch":"$context.requestTimeEpoch","httpMethod":"$context.httpMethod","routeKey":"$context.routeKey","status":"$context.status","protocol":"$context.protocol","responseLength":"$context.responseLength","integration error":"$context.integrationErrorMessage"}';
    ...
    constructor(scope: Construct, id: string, props: IConfigProps) {
      ...
      const folder = props.demoWebsite
      ? "demo_website"
      : "empty_demo_website";
      ...
      const customResourceLE = new CustomResourceLambdaEdge(this, "CustomResourceLE", {
