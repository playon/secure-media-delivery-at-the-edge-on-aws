...
- Upgraded all AWS Lambda functions from Node.js 18 runtime to Node.js 22 runtime
- Updated package.json to require Node.js 22.x or later
- Updated @types/node dependency to support Node.js 22
- Updated README.md documentation to reflect Node.js 22 requirement

### Security

- Node.js 22 provides improved security features and performance optimizations
