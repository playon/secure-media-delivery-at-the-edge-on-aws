...
function _aws_cdk_aws_apigatewayv2_alpha_GrantInvokeOptions(p) {
    ...
    if (!visitedObjects.has(p.httpMethods))
        _aws_cdk_aws_apigatewayv2_alpha_HttpMethod(p.httpMethods);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_apigatewayv2_alpha_CorsPreflightOptions(p) {
    ...
    if (!visitedObjects.has(p.allowMethods))
        _aws_cdk_aws_apigatewayv2_alpha_CorsHttpMethod(p.allowMethods);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_apigatewayv2_alpha_AddRoutesOptions(p) {
    ...
    if (!visitedObjects.has(p.methods))
        _aws_cdk_aws_apigatewayv2_alpha_HttpMethod(p.methods);
    if (!visitedObjects.has(p.integration))
        _aws_cdk_aws_apigatewayv2_alpha_HttpRouteIntegration(p.integration);
    visitedObjects.delete(p);
}
...
module.exports = { print, _aws_cdk_aws_apigatewayv2_alpha_SecurityPolicy, _aws_cdk_aws_apigatewayv2_alpha_EndpointType, _aws_cdk_aws_apigatewayv2_alpha_CorsHttpMethod, _aws_cdk_aws_apigatewayv2_alpha_HttpMethod, _aws_cdk_aws_apigatewayv2_alpha_HttpIntegrationType, _aws_cdk_aws_apigatewayv2_alpha_HttpIntegrationSubtype, _aws_cdk_aws_apigatewayv2_alpha_HttpConnectionType, _aws_cdk_aws_apigatewayv2_alpha_HttpAuthorizerType, _aws_cdk_aws_apigatewayv2_alpha_AuthorizerPayloadVersion, _aws_cdk_aws_apigatewayv2_alpha_WebSocketIntegrationType, _aws_cdk_aws_apigatewayv2_alpha_WebSocketAuthorizerType, _aws_cdk_aws_apigatewayv2_alpha_StageAttributes, _aws_cdk_aws_apigatewayv2_alpha_ApiMappingAttributes, _aws_cdk_aws_apigatewayv2_alpha_IMappingValue, _aws_cdk_aws_apigatewayv2_alpha_HttpAuthorizerAttributes, _aws_cdk_aws_apigatewayv2_alpha_WebSocketAuthorizerAttributes, _aws_cdk_aws_apigatewayv2_alpha_DomainNameAttributes, _aws_cdk_aws_apigatewayv2_alpha_HttpApiAttributes, _aws_cdk_aws_apigatewayv2_alpha_WebSocketApiAttributes, _aws_cdk_aws_apigatewayv2_alpha_WebSocketRouteAuthorizerConfig, _aws_cdk_aws_apigatewayv2_alpha_HttpRouteAuthorizerConfig, _aws_cdk_aws_apigatewayv2_alpha_IIntegration, _aws_cdk_aws_apigatewayv2_alpha_IRoute, _aws_cdk_aws_apigatewayv2_alpha_IDomainName, _aws_cdk_aws_apigatewayv2_alpha_IApiMapping, _aws_cdk_aws_apigatewayv2_alpha_IAuthorizer, _aws_cdk_aws_apigatewayv2_alpha_HttpStageOptions, _aws_cdk_aws_apigatewayv2_alpha_IHttpAuthorizer, _aws_cdk_aws_apigatewayv2_alpha_IWebSocketApi, _aws_cdk_aws_apigatewayv2_alpha_IWebSocketAuthorizer, _aws_cdk_aws_apigatewayv2_alpha_DomainMappingOptions, _aws_cdk_aws_apigatewayv2_alpha_GrantInvokeOptions, _aws_cdk_aws_apigatewayv2_alpha_MTLSConfig, _aws_cdk_aws_apigatewayv2_alpha_BatchHttpRouteOptions, _aws_cdk_aws_apigatewayv2_alpha_WebSocketRouteIntegrationConfig, _aws_cdk_aws_apigatewayv2_alpha_VpcLinkAttributes, _aws_cdk_aws_apigatewayv2_alpha_StageOptions, _aws_cdk_aws_apigatewayv2_alpha_HttpRouteIntegrationBindOptions, _aws_cdk_aws_apigatewayv2_alpha_HttpRouteAuthorizerBindOptions, _aws_cdk_aws_apigatewayv2_alpha_WebSocketRouteIntegrationBindOptions, _aws_cdk_aws_apigatewayv2_alpha_WebSocketRouteAuthorizerBindOptions, _aws_cdk_aws_apigatewayv2_alpha_DomainNameProps, _aws_cdk_aws_apigatewayv2_alpha_IHttpIntegration, _aws_cdk_aws_apigatewayv2_alpha_HttpStageProps, _aws_cdk_aws_apigatewayv2_alpha_HttpStageAttributes, _aws_cdk_aws_apigatewayv2_alpha_IVpcLink, _aws_cdk_aws_apigatewayv2_alpha_IWebSocketRoute, _aws_cdk_aws_apigatewayv2_alpha_WebSocketRouteProps, _aws_cdk_aws_apigatewayv2_alpha_IWebSocketStage, _aws_cdk_aws_apigatewayv2_alpha_WebSocketStageProps, _aws_cdk_aws_apigatewayv2_alpha_IWebSocketIntegration, _aws_cdk_aws_apigatewayv2_alpha_WebSocketStageAttributes, _aws_cdk_aws_apigatewayv2_alpha_WebSocketRouteIntegration, _aws_cdk_aws_apigatewayv2_alpha_IHttpRouteAuthorizer, _aws_cdk_aws_apigatewayv2_alpha_WebSocketIntegrationProps, _aws_cdk_aws_apigatewayv2_alpha_IWebSocketRouteAuthorizer, _aws_cdk_aws_apigatewayv2_alpha_WebSocketRouteOptions, _aws_cdk_aws_apigatewayv2_alpha_WebSocketAuthorizerProps, _aws_cdk_aws_apigatewayv2_alpha_CorsPreflightOptions, _aws_cdk_aws_apigatewayv2_alpha_HttpRouteIntegration, _aws_cdk_aws_apigatewayv2_alpha_WebSocketApiKeySelectionExpression, _aws_cdk_aws_apigatewayv2_alpha_IStage, _aws_cdk_aws_apigatewayv2_alpha_IApi, _aws_cdk_aws_apigatewayv2_alpha_AddRoutesOptions, _aws_cdk_aws_apigatewayv2_alpha_HttpNoneAuthorizer, _aws_cdk_aws_apigatewayv2_alpha_WebSocketNoneAuthorizer, _aws_cdk_aws_apigatewayv2_alpha_IntegrationCredentials, _aws_cdk_aws_apigatewayv2_alpha_PayloadFormatVersion, _aws_cdk_aws_apigatewayv2_alpha_ApiMappingProps, _aws_cdk_aws_apigatewayv2_alpha_VpcLinkProps, _aws_cdk_aws_apigatewayv2_alpha_IHttpRoute, _aws_cdk_aws_apigatewayv2_alpha_HttpRouteProps, _aws_cdk_aws_apigatewayv2_alpha_WebSocketApiProps, _aws_cdk_aws_apigatewayv2_alpha_HttpApiProps, _aws_cdk_aws_apigatewayv2_alpha_HttpIntegration, _aws_cdk_aws_apigatewayv2_alpha_WebSocketRoute, _aws_cdk_aws_apigatewayv2_alpha_WebSocketIntegration, _aws_cdk_aws_apigatewayv2_alpha_HttpAuthorizerProps, _aws_cdk_aws_apigatewayv2_alpha_HttpAuthorizer, _aws_cdk_aws_apigatewayv2_alpha_WebSocketAuthorizer, _aws_cdk_aws_apigatewayv2_alpha_EndpointOptions, _aws_cdk_aws_apigatewayv2_alpha_DomainName, _aws_cdk_aws_apigatewayv2_alpha_HttpRoute, _aws_cdk_aws_apigatewayv2_alpha_ApiMapping, _aws_cdk_aws_apigatewayv2_alpha_MappingValue, _aws_cdk_aws_apigatewayv2_alpha_VpcLink, _aws_cdk_aws_apigatewayv2_alpha_HttpRouteKey, _aws_cdk_aws_apigatewayv2_alpha_WebSocketApi, _aws_cdk_aws_apigatewayv2_alpha_WebSocketStage, _aws_cdk_aws_apigatewayv2_alpha_ParameterMapping, _aws_cdk_aws_apigatewayv2_alpha_IHttpStage, _aws_cdk_aws_apigatewayv2_alpha_IHttpApi, _aws_cdk_aws_apigatewayv2_alpha_HttpStage, _aws_cdk_aws_apigatewayv2_alpha_HttpRouteIntegrationConfig, _aws_cdk_aws_apigatewayv2_alpha_HttpIntegrationProps, _aws_cdk_aws_apigatewayv2_alpha_HttpApi };
