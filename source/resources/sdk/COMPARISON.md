...
| Feature | Node.js | Python | Java | Perl |
|---------|---------|---------|------|------|
| **Async Pattern** | Promises | async/await | CompletableFuture | Sync |
| **Booleans** | true/false | True/False | true/false | 1/0 |
| **Package Manager** | npm | pip | Maven/Gradle | CPAN |
| **Memory Usage** | ~50-100MB | ~60-120MB | ~80-150MB | ~30-70MB |
| **Cold Start** | ~100-200ms | ~200-400ms | ~300-800ms | ~100-250ms |
